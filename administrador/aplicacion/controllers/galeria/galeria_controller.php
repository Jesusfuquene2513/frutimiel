...
$peticion = $instancia -> crear_album($nombre_album);
...
return $peticion;
	...
	$instancia = new Galeria_model();	
	$peticion = $instancia -> editar_album($nombre_album , $album_id);
	}
...
$peticion2 = $instancia -> eliminar_album($album_id);
	...
	public function listar_elementos_galeria_front_page(){
		$instancia = new Galeria_model();
		$peticion = $instancia -> listar_elementos_galeria_front_page();
		return $peticion;
	}

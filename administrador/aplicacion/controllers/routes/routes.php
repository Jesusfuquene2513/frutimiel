...
<td class="text-center" style="vertical-align: middle; border:solid 0.5px gray">' . $contacto['fecha_creacion'] . '</td>
    ...
    echo ' <div class="carousel-item">
      <img src="'.$ruta_nueva.'" class="d-block img-carrusel w-100" alt="...">
    </div>';
      ...
      <div class="container p-0">
        ...
        $peticion = $instancia->listar_programas();
                                    ...
                                    foreach($peticion as $producto){
                                         ...
                                         $ruta = $producto['portada_programa'];
                 ...
                 if (strpos($ruta, 'http') !== false) {
                  ...
                  $ruta_nueva = "../administrador/".$ruta;    
                                        ...
                                        echo ' <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 m-auto wow fadeInUp producto-item producto-item2 " data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;" data-bs-toggle="tooltip" data-bs-html="true" data-bs-title="<i><b>'.$producto['nombre_programa'].'</b></i>" data-bs-placement="top">
                    <div class="service-item service-item2 bg-white  card" style="position:relative;">
                    
                        <img class="img-fluid mb-1 " src="'.$ruta_nueva.'" alt="" style="width:100%" >
                       
                        <center><h4>'.$producto['nombre_programa'].'</h4></center>
                        <br>
                        <p class="p-3" style="color:black; font-weight:bolder; line-height:35px">'.$producto['contenido_programa'].'</p>
                        <br>
                       <center> <button class="btn btn-primary" ><a href="https://api.whatsapp.com/send?phone=573182525189" target="_blank" style="color:white">Solicitar</a></button></center>
                       <br>
        ...
        $peticion = $instancia->listar_publicaciones();
                                    ...
                                    foreach($peticion as $publicacion){
                                       ...
                                       <img src="'.$publicacion['portada'].'" class="img-fluid elemento-blog" title="'.$publicacion['tipo_elemento'].'" style="height:350px; width:100%">
                                       <br>
                                       <br>
                                      <h4 class="text-left">'.$publicacion['titulo'].'</h4>
                                   
                                      
                                      <p style="color:black">'.$publicacion['contenido'].'</p>
                                    
                                      <span class="btn btn-primary" style="font-weight:bolder">Publicado el '.$publicacion['fecha_creacion'].'</span>
 ...
 echo '<div class="col-xl-2 col-lg-3 col-md-3 col-sm-4 col-12 mt-2 mb-2 item-carga-imagen p-1" style="position:relative; float:left">
        ...
        foreach($peticion as $album){
            ...
            <div class="portfolio-img rounded overflow-hidden">
                <img class="img-fluid imagen-archivo" src="https://www.revistacredencial.com/sites/default/files/panoramica_del_malecon_bahia_de_la_cruz.jpg" alt="" style="height:300px">
                <div class="portfolio-btn" style="width:100%; background:rgb(0 , 0 , 0 , 0.9); display:flex; align-items: center;height:50px;">
                  <center>  <a class="btn natalia btn-lg-square m-auto rounded-circle mx-1" href="https://www.revistacredencial.com/sites/default/files/panoramica_del_malecon_bahia_de_la_cruz.jpg" data-lightbox="portfolio" style="background:white"><i class="fa fa-eye"></i></a></center>

...
class Galeria_model{
	...
	public function crear_album($nombre_album){

		 $instancia = new Conexion();
        $pdo = $instancia->establecer_conexion();

        $sentencia = $pdo->prepare("INSERT INTO album (nombre_album , fecha_creacion)  VALUES (:album , now())");
	...
	public function editar_album($nombre_album , $album_id){
		 $instancia = new Conexion();
        $pdo = $instancia->establecer_conexion();

        $sentencia = $pdo->prepare("UPDATE album SET nombre_album=:nombre_album ,  fecha_creacion=now() WHERE album_id = :album_id ");
...
$instancia = new Conexion();
        ...
        return $statement;  
         ...
         public function listar_elementos_galeria_front_page(){
        $instancia = new Conexion();
        $pdo = $instancia->establecer_conexion();

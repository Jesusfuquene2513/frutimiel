...
<body class="login">
	<div class="wrapper wrapper-login">
		<form action="aplicacion/controllers/routes/routes.php" method="post">
			...
			<center>    <img src="../plantilla/assets/img/logo.png" alt="navbar brand" class="navbar-brand" style="width:280px"></center>
			<div class="login-form">
				...
				<div class="login-account">
					...
					<button type="submit" class="btn" style="background-color: #ec6c1c; color:white; padding: 5px; font-size:20px">Login</button>
				</div>
			</div>
		</div>
		</form>

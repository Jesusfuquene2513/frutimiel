...
#footer{
    ...
    background-image: url("../plantilla_front/img/panal2.png");
...
$this->load->view('vistas/header');
			...
			<section class="p-0" style="position:relative; top:80px;">
				<?php
$this->load->view('vistas/slider');
				?>
			</section>
			<section class="p-0">
...
$this->load->view('vistas/footer');
        ...
        <script src="../plantilla/assets/personalizados/js/counterup/counterup.min.js"></script>
           ...
           <script src="../plantilla/assets/personalizados/js/slider.js"></script>
